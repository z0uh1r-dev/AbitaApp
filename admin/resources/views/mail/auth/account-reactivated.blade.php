			...
			<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:640px; background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0;">
				<tr>
					<td style="background:linear-gradient(135deg,#00a1e0,#0284c7); padding:24px 28px; text-align:center;">
						...
						<p style="margin:0; font-size:13px; letter-spacing:1px; text-transform:uppercase; color:#dbeafe;">Account notice</p>
						<h1 style="margin:8px 0 0; font-size:24px; line-height:1.3; color:#ffffff;">Your account has been reactivated</h1>
					</td>
				</tr>
				...
				<tr>
					<td style="padding:24px 28px;">
						<p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#334155;">
							Hi {{ $user->first_name }}, your access to {{ config('app.name') }} has been restored. You can sign in as usual.
						</p>
